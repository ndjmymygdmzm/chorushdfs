...
public class V0201PluginTest extends AbstractPluginTest {

    @Before
    public void setUp() throws Exception {
        hdfs = hdfsForKey("gphd20");
    }
    ...
    public void testDetails() throws Exception {
        ...
        assertThat("it has the owner", details.getOwner(), is(ps.getProperty("gphd20.user")));
    }
